 ...
 * @since 02-06-2020
 */
public class MyCardTouchHelper extends ItemTouchHelper.Callback {
     ...
     *
     * @param cardTouchHelperAdapter The interface that allows see the trigger the callback
     */
    public MyCardTouchHelper(CardTouchHelperAdapter cardTouchHelperAdapter) {
    ...
    public boolean onMove(@NonNull RecyclerView recyclerView, @NonNull RecyclerView.ViewHolder viewHolder, @NonNull RecyclerView.ViewHolder target) {
        mCardTouchHelperAdapter.onItemMove(viewHolder.getAdapterPosition(), target.getAdapterPosition());
        return false;
    }
    ...
    public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
        mCardTouchHelperAdapter.onItemSwiped(viewHolder.getAdapterPosition());
    }
}
